...
class TestRule(unittest.TestCase):
    ...
    def testA_post(self):
        ...
        1. Check 'unauthorized on rule upload'
        2. Check 'upload succeed'
        """
        rv = self.client.post('/admin/rule')
    ...
    def testC_patch(self):
        ...
        1. Check 'unauthorized on rule getting'
        2. Load/Check 'existing(uploaded) rule'
        3. Check 'unauthorized on rule patch'
        ...
        rv = self.client.patch('/admin/rule')
        self.assertEqual(rv.status_code, 401)
        # Unauthorized check
    ...
    def testD_delete(self):
        ...
        1. Check 'unauthorized on rule getting'
        2. Load/Check 'existing(uploaded) rule'
        3. Check 'unauthorized on rule delete'
        ...
        rv = self.client.delete('/admin/rule')
        self.assertEqual(rv.status_code, 401)
        # Unauthorized check
